...
+ Experience Platform Launch ワークフローの一部として Places Service を使用する {#use-places-launch-workflow}
   + [Experience Platform Launch ワークフローの一部として Places Service を使用する](use-places-launch-workflow/places-launch-workflow.md)
...
+ Places Service を他のAdobe ソリューションと併用する {#use-places-with-other-solutions}
